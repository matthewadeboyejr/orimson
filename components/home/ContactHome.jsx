...
const ContactHome = () => {
  return (
    <section className="w-full mb-24">
      <div className="flex flex-col-reverse lg:flex-row justify-center items-center gap-8 bg-red-500 rounded-3xl p-10 header-overlay ">
        <div className="flex items-center w-full lg:w-1/2 md:mt-12">
          <div className="space-y-4  ">
            <h2 className="text-5xl font-black text-white md:font-medium w-full ">
              Get A Consultation Now!
            </h2>
            <p className="text-base sm:text-lg md:text-lg text-center opacity-80 text-white">
